...
public class Es7ConsumerSender extends ConsumerSenderAbs<Builder> {
    ...
    public Es7ConsumerSender(JSONObject params) {
        super(params);
    }
...
//        esDataBuilder.setType(type);
        ...
        if (isroot) {// 根元素或是没有关联关联的索引
            ...
            String parentId =  datamap.get(relaNameAry[1]);//需考虑幂等情况  DuckulaAssit.getValueStr(duckulaEvent, relaNameAry[1]);
            // 找id
